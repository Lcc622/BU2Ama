...
from app.config import ALLOWED_STORE_PREFIXES, RESULTS_DIR, TEMPLATES, UPLOADS_DIR
from app.core.color_mapper import color_mapper
from app.models.excel import SKUInfo, ColorDistribution, AnalysisResult

STORE_PREFIX_PATTERN = re.compile(r"^(DM|DA|PZ)-", re.IGNORECASE)
STORE_SOURCE_FILE_PATTERN = re.compile(r"^(DM|DA|PZ)-\d", re.IGNORECASE)
STORE_PRIORITY = ("DM", "PZ")
...
class ExcelProcessor:
    ...
    def _is_plus_body_suffix(self, suffix: Optional[str]) -> bool:
        ...
        return normalized in {"-PLPH", "-DAPH"}
            ...
            if req_info.suffix:
                ...
                if has_base_suffix and not has_plus_suffix:
                    ...
                    if style_has_base and style_has_plus:
                        ...
                        # 避免 Plus-only-PL 类产品（如 ES01886 源全是 -PL）被误落到 -PLPH
