...
export const FollowSellUpload: React.FC = () => {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState<'DaMaUS' | 'PZUS'>('DaMaUS');
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mb-4">
          ...
          <p className="mt-1 text-xs text-gray-500">按每条 SKC 自动查新老款映射，再到 {selectedTemplate === 'DaMaUS' ? 'DA' : 'PZ'}-0/1/2 聚合表提取全部尺码</p>
        </div>
